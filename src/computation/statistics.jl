...
This is a zero-allocation wrapper around FormulaCompiler.delta_method_se()
...
"""
@inline function compute_delta_method_se(gradient::Vector{Float64}, Σ::Matrix{Float64})::Float64
...
"""
@inline function compute_se_only(gradient::Vector{Float64}, Σ::Matrix{Float64})::Float64
    return FormulaCompiler.delta_method_se(gradient, Σ)
end
