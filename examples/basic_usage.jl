...
println("• target = :mu (response) or :eta (link) for effects")
println("• scale = :response or :link for predictions")
println("• at = :means or Dict(...) for profile specifications")
println()
