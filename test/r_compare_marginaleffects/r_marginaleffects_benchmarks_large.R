# r_marginaleffects_benchmarks_large.R
# R performance benchmarks on large dataset (500K observations) using marginaleffects
...
cat("================================================================================\n")
cat("R LARGE-SCALE PERFORMANCE BENCHMARK with marginaleffects (500K observations)\n")
cat("================================================================================\n\n")
...
cat("================================================================================\n")
cat("RUNNING BENCHMARKS with marginaleffects (LARGE DATASET)\n")
cat("================================================================================\n\n")
...
saveRDS(benchmarks, "r_marginaleffects_benchmarks_large.rds")

cat("================================================================================\n")
cat("RESULTS SAVED\n")
cat("================================================================================\n\n")
cat("✓ r_marginaleffects_benchmarks_large.rds\n\n")
...
cat("Total operation time:",
    ...
    "s (R marginaleffects - large dataset)\n\n")
cat("Next: Compare with Julia using compare_performance_marginaleffects_large.jl\n\n")
