# r_benchmarks.R
# R performance benchmarks for comparison with Julia
...
cat("================================================================================\n")
cat("R PERFORMANCE BENCHMARK (Speed & Memory)\n")
cat("================================================================================\n\n")
...
saveRDS(benchmarks, "r_benchmarks.rds")

cat("================================================================================\n")
cat("RESULTS SAVED\n")
cat("================================================================================\n\n")
cat("✓ r_benchmarks.rds\n\n")
...
cat("Total operation time:",
    ...
    "s (R)\n\n")
cat("Next: Compare with Julia using compare_performance.jl\n\n")
