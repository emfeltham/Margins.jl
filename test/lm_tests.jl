...
@testset "AME LM Tests" begin
    ...
    @testset "Scenario 2: Interaction" begin
        ...
        @test isapprox(ame2.effects[:SepalWidth], ame_closed; atol=1e-6)
        @test isapprox(ame2.ses[:SepalWidth], se_closed; atol=1e-6)
    end
    ...
    @testset "Scenario 3: Transformation of predictor" begin
        ...
        @test isapprox(ame3.effects[:SepalWidth], ame_closed3; atol=1e-5)
        @test isapprox(ame3.ses[:SepalWidth], se_closed3; atol=1e-5)
    end
